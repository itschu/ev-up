      ...
      {!submitted ? (
        <>
          <div className="mb-10 mt-5 md:mb-20 flex flex-col">
            <h2 className="heading mt-20 md:mt-10 text-left">Book Product</h2>
          </div>
            ...
            <div className="relative">
              <div className="single-contact-info ">
                ...
                <span className="ml-3 text-2xl font-extrabold">
                  EV-UP <span className="capitalize">{selected.type}</span>
                </span>
              </div>
              <div className="single-contact-info ">
                <svg
                ...
                <span className="ml-3 text-2xl font-extrabold">
                  {price[selected.type][selected.billed].toLocaleString(
                    "en-US",
                    {
